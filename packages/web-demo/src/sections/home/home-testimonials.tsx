...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    category: 'Design Quality',
    content:
      "Amazing. I've never purchased complete front ends before, but I'll definitely be doing this again!",
  ...
  },
  {
    ...
    content:
      'Thanks to Minimal for customer support with email. I solved the problem. And the code quality is good, too.',
