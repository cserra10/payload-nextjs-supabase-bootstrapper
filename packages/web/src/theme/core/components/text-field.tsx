...
export const INPUT_PADDING: Record<string, Record<string, CSSObject>> = {
  base: {
    small: { paddingTop: 0, paddingBottom: 2 },
    medium: { paddingTop: 2, paddingBottom: 2 },
  },
  outlined: {
    small: { paddingTop: 3, paddingBottom: 3 },
    medium: { paddingTop: 6, paddingBottom: 6 },
  },
  filled: {
    small: { paddingTop: 15 },
    medium: { paddingTop: 18 },
    smallHidden: { paddingTop: 3, paddingBottom: 3 },
    mediumHidden: { paddingTop: 6, paddingBottom: 6 },
  },
};
